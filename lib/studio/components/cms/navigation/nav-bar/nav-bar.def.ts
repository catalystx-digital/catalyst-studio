...
export const NavBarDef = defineComponent({
  ...
  directives: [
    ...
    'Logos must return both logo.src and logo.originalUrl (absolute URLs) plus alt/href metadata. When the DOM supplies only a relative path, resolve it before populating src/originalUrl; missing originalUrl requires re-fetching the header.',
