...
export const CTABannerDef = defineComponent({
  ...
  schema: z.object({
    ...
    primaryButton: CTAButtonSchema.optional().describe('Primary action button'),
  ...
  directives: [
    ...
    '',
    'Data requirements: Populate heading, subheading (if present), and button configurations when buttons are visible.',
    'primaryButton and secondaryButton should capture label, href, and variant exactly as shown.',
    'When background has a distinct color or image, use backgroundColor or backgroundImage.',
    ...
    '    "primaryButton": { "label": "Donate Now", "href": { "type": "internal", "pageId": "donate", "path": "/donate" }, "variant": "primary" },',
    '    "secondaryButton": { "label": "Learn More", "href": { "type": "internal", "pageId": "foundation", "path": "/foundation" }, "variant": "outline" },',
    '    "alignment": "center",',
    '    "fullWidth": true',
    '  }',
    '',
