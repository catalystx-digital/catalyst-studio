...
export const HeroWithImageDef = defineComponent({
  ...
  directives: [
    ...
    'Data requirements: Extract full hero copy (eyebrow, heading, subheading, body) plus layout/theme values when present. Include image as { "src": { "mediaId": "detected:<stable-kebab-id>", "mediaType": "image", "url": "https://..." }, "alt": "..." }. Do not flatten mediaId, mediaType, or url onto image. Do not emit undocumented top-level visual sizing fields such as height.',
    ...
    '    "layout": "image-right",',
    '    "image": { "src": { "mediaId": "detected:hero-students", "mediaType": "image", "url": "https://example.com/hero.jpg" }, "alt": "Students collaborating in class" },',
    '    "ctaButtons": [{ "label": "Explore schools", "href": { "type": "internal", "pageId": "schools", "path": "/schools" }, "variant": "primary" }]',
    '  }',
    'Mapping guidance: use the hero headline (h1/h2) for "heading", supporting line for "subheading", paragraph copy for "body", and capture eyebrow tags or badges as "eyebrow". Pull the hero <img> absolute URL + alt into image.src MediaReference/alt and convert CTA anchors into ctaButtons[] entries with SmartLink href, label, and variant classes.',
