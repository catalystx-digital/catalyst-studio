...
export const BlogPostDef = defineComponent({
  ...
  directives: [
    ...
    'For hero images, populate heroImage with { src: MediaReference object, alt, caption, dominantColor } when available.',
    ...
    '    "tags": ["Local news"],',
    '    "heroImage": { "src": { "mediaId": "detected:partnership-signing", "mediaType": "image", "url": "https://..." }, "alt": "Partnership signing ceremony" },',
